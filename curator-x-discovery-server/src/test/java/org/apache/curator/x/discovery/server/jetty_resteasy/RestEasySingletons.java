...
/**
 * For testing purposes only. You will inject these however is appropriate for
 * your application
 */
public class RestEasySingletons {
	...
	public final StringDiscoveryContext contextSingleton = new StringDiscoveryContext(serviceDiscoverySingleton,
			new RandomStrategy<String>(), 1000);
	public final JsonServiceInstanceMarshaller<String> serviceInstanceMarshallerSingleton = new JsonServiceInstanceMarshaller<String>(
			contextSingleton);
	public final JsonServiceInstancesMarshaller<String> serviceInstancesMarshallerSingleton = new JsonServiceInstancesMarshaller<String>(
			contextSingleton);
