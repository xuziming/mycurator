...
/**
 * A background task that purges stale registrations. You should allocate a
 * singleton of this class, call {@link #start()} and then call {@link #close()}
...
public class InstanceCleanup implements Closeable {
	 ...
	 * @param instanceRefreshMs time in milliseconds to consider a registration
	 *                          stale
	 */
	@SuppressWarnings("unchecked")
	public InstanceCleanup(ServiceDiscovery<?> discovery, int instanceRefreshMs) {
		// noinspection unchecked
		this.discovery = (ServiceDiscovery<Object>) discovery; // this cast is safe - this class never accesses the
																// payload
	...
	public void start() {
		...
		}, instanceRefreshMs, instanceRefreshMs, TimeUnit.MILLISECONDS);
	}
