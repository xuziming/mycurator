...
/**
 * For convenience, a version of {@link DiscoveryContext} that uses an int as
 * the payload
 */
@Provider
public class IntegerDiscoveryContext implements DiscoveryContext<Integer>, ContextResolver<DiscoveryContext<Integer>> {
	...
	public IntegerDiscoveryContext(ServiceDiscovery<Integer> serviceDiscovery,
			ProviderStrategy<Integer> providerStrategy, int instanceRefreshMs) {
