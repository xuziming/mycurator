...
/**
 * For convenience, a version of {@link DiscoveryContext} that uses a string as
 * the payload
 */
@Provider
public class StringDiscoveryContext implements DiscoveryContext<String>, ContextResolver<DiscoveryContext<String>> {
	...
	public StringDiscoveryContext(ServiceDiscovery<String> serviceDiscovery, ProviderStrategy<String> providerStrategy,
