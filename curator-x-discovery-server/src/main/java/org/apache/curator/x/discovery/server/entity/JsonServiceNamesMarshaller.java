...
public class JsonServiceNamesMarshaller implements MessageBodyReader<ServiceNames>, MessageBodyWriter<ServiceNames> {
	...
	@Override
	public ServiceNames readFrom(Class<ServiceNames> type, Type genericType, Annotation[] annotations,
	...
	@Override
	public long getSize(ServiceNames serviceNames, Class<?> type, Type genericType, Annotation[] annotations,
			MediaType mediaType) {
		return -1;
	}

	@Override
	public void writeTo(ServiceNames serviceNames, Class<?> type, Type genericType, Annotation[] annotations,
