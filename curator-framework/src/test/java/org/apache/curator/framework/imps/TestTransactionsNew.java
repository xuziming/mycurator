...
public class TestTransactionsNew extends BaseClassForTests {
	...
	public void testWithNamespace() throws Exception {
		...
		try {
			...
			CuratorOp createOp2 = client.transactionOp().create().withMode(CreateMode.PERSISTENT_SEQUENTIAL)
	...
	public void testBackgroundWithNamespace() throws Exception {
		...
		try {
			...
			client.transaction().inBackground(callback).forOperations(createOp1, createOp2, setDataOp, createOp3,
					deleteOp);
