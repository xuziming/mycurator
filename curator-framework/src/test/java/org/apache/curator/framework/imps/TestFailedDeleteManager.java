...
public class TestFailedDeleteManager extends BaseClassForTests {
	...
	public void testBasic() throws Exception {
		...
		builder.connectString(server.getConnectString()).retryPolicy(new RetryOneTime(1))
	...
	public void testGuaranteedDeleteOnNonExistentNodeInForeground() throws Exception {
		...
		((CuratorFrameworkImpl) client)
				.getFailedDeleteManager().debugListener = new FailedOperationManager.FailedOperationManagerListener<String>() {
