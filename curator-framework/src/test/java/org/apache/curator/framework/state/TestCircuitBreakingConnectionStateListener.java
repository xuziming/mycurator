...
public class TestCircuitBreakingConnectionStateListener {
	...
	public void testBasic() throws Exception {
		...
		CircuitBreakingConnectionStateListener listener = new CircuitBreakingConnectionStateListener(dummyClient,
				recordingListener, retryPolicy, service);
		...
		synchronized (listener) // don't let retry policy run while we're pushing state changes
		{
			...
			listener.stateChanged(dummyClient, ConnectionState.SUSPENDED); // all further events are ignored - this will
																			// be the last event
		}
	...
	public void testRetryNever() throws Exception {
		...
		CircuitBreakingConnectionStateListener listener = new CircuitBreakingConnectionStateListener(dummyClient,
				recordingListener, retryNever, service);
	...
	public void testRetryOnce() throws Exception {
		...
		CircuitBreakingConnectionStateListener listener = new CircuitBreakingConnectionStateListener(dummyClient,
				recordingListener, retryOnce, service);
	...
	public void testSuspendedToLostRatcheting() throws Exception {
		...
		CircuitBreakingConnectionStateListener listener = new CircuitBreakingConnectionStateListener(dummyClient,
				recordingListener, retryInfinite, service);
