...
public class TestReadOnly {
	...
	public void testConnectionStateNewClient() throws Exception {
		...
		try {
			...
			client = CuratorFrameworkFactory.builder().connectString(cluster.getConnectString())
					...
					.retryPolicy(new RetryNTimes(3, timing.milliseconds())).canBeReadOnly(true).build();
	...
	public void testReadOnly() throws Exception {
		...
		try {
			...
			client = CuratorFrameworkFactory.builder().connectString(cluster.getConnectString()).canBeReadOnly(true)
