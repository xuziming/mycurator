...
public class TestRemoveWatches extends CuratorTestBase {
	...
	/**
	 * Test the case where we try and remove an unregistered watcher. In this case
	 * we expect a NoWatcherException to be thrown.
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * Test the case where we try and remove an unregistered watcher but have the
	 * quietly flag set. In this case we expect success.
	 * 
	 * @throws Exception
	 */
	@Test
