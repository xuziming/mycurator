...
public class TestGzipCompressionProvider {
	...
	/**
	 * This test ensures that in the face of corrupt data, specifically IOException
	 * is thrown, rather some other kind of runtime exception. Users of
	 * {@link GzipCompressionProvider#decompress(String, byte[])} may depend on
	 * this.
	 */
	@Test
