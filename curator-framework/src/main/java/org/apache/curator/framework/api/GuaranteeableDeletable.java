 ...
 * deletions and attempt to delete them in the background until successful.
 * NOTE: you will still get an exception when the deletion fails. But, you can
 * be assured that as long as the
 * {@link org.apache.curator.framework.CuratorFramework} instance is open
