...
/**
 * Similar to {@link org.apache.curator.utils.EnsurePath} but creates
 * containers.
 *
 */
public class EnsureContainers {
	...
	/**
	 * The first time this method is called, all nodes in the path will be created
	 * as containers if needed
	 *
	...
	/**
	 * Reset so that the next call to {@link #ensure()} will attempt to create
	 * containers
	 */
	public void reset() {
