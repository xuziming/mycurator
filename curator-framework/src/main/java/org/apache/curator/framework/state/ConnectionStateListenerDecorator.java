...
/**
 * <p>
 * Allows for the enhancement of the
 * {@link org.apache.curator.framework.state.ConnectionStateListener} instances
 * used with Curator. Client code that sets a ConnectionStateListener should
 * always wrap it using the configured ConnectionStateListenerDecorator. All
 * Curator recipes do this.
 * </p>
 *
 * <p>
 * E.g.
...
public interface ConnectionStateListenerDecorator {
	...
	/**
	 * Decorates the listener with circuit breaking behavior using
	 * {@link org.apache.curator.framework.state.CircuitBreakingConnectionStateListener}
	 *
