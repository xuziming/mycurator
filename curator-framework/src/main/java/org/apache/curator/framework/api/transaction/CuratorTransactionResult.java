...
public class CuratorTransactionResult {
	...
	/**
	 * Returns the operation generated path or <code>null</code>. i.e.
	 * {@link CuratorTransaction#create()} using an EPHEMERAL mode generates the
	 * created path plus its sequence number.
	 *
	...
	/**
	 * Returns the operation generated stat or <code>null</code>. i.e.
	 * {@link CuratorTransaction#setData()} generates a stat object.
	 *
	...
	/**
	 * Returns the operation generated error or <code>0</code> i.e.
	 * {@link OpResult.ErrorResult#getErr()}
	 *
	 * @return error or 0
	 */
	public int getError() {
