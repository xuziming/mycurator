...
public interface CuratorMultiTransactionMain {
	/**
	 * Commit the given operations as a single transaction. Create the operation
	 * instances via {@link CuratorFramework#transactionOp()}
	 *
	 * @param operations operations that make up the transaction.
	 * @return result details for foreground operations or <code>null</code> for
