...
public interface ParentACLable<T> extends ACLable<T> {
	 ...
	 *
	 * If applyToParents is true, then the aclList is applied to the created
	 * parents. Existing parent nodes are not affected.
	 *
	 * @param aclList        the ACL list to use
	 * @param applyToParents if true, then the aclList is applied to the created
	 *                       parents.
	 * @return this
	 */
