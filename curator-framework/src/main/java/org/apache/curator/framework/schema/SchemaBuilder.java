...
public class SchemaBuilder {
	 ...
	 */
	public Schema build() {
		return new Schema(name, pathRegex, path, documentation, schemaValidator, ephemeral, sequential, watched,
	...
	/**
	 * @param schemaValidator a data validator - will be used to validate data set
	 *                        for the znode
	 * @return this for chaining
	 */
