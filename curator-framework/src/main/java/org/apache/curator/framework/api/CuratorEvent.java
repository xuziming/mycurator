 ...
 *
 * IMPORTANT: the methods only return values as specified by the operation that
 * generated them. Many methods will return <tt>null</tt>
 */
public interface CuratorEvent {
	/**
	 * check here first - this value determines the type of event and which methods
	...
	/**
	 * @return the context object passed to
	 *         {@link Backgroundable#inBackground(Object)}
	 */
