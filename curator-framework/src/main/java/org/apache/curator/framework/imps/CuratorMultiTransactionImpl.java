...
public class CuratorMultiTransactionImpl implements CuratorMultiTransaction, CuratorMultiTransactionMain,
		BackgroundOperation<CuratorMultiTransactionRecord>, ErrorListenerMultiTransactionMain {
	...
	public List<CuratorTransactionResult> forOperations(List<CuratorOp> operations) throws Exception {
		...
		if (backgrounding.inBackground()) {
			client.processBackgroundOperation(new OperationAndData<>(this, record, backgrounding.getCallback(), null,
			...
			AsyncCallback.MultiCallback callback = new AsyncCallback.MultiCallback() {
				...
				public void processResult(int rc, String path, Object ctx, List<OpResult> opResults) {
					...
					List<CuratorTransactionResult> curatorResults = (opResults != null)
							...
							: null;
					CuratorEvent event = new CuratorEventImpl(client, CuratorEventType.TRANSACTION, rc, path, null, ctx,
							null, null, null, null, null, curatorResults);
	...
	private List<CuratorTransactionResult> forOperationsInForeground(final CuratorMultiTransactionRecord record)
		...
		List<OpResult> responseData = RetryLoop.callWithRetry(client.getZookeeperClient(),
