...
public class ExceptionAccumulator {
	...
	/**
	 * Add an exception into the accumulated exceptions. Note: if the exception is
	 * {@link java.lang.InterruptedException} then
	 * <code>Thread.currentThread().interrupt()</code> is called.
	 *
