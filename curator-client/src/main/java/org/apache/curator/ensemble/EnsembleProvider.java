...
public interface EnsembleProvider extends Closeable {
	...
	/**
	 * Return the current connection string to use. Curator will call this each time
	 * it needs to create a ZooKeeper instance
	 * 
	...
	/**
	 * Curator will call this method when {@link CuratorZookeeperClient#close()} is
	 * called
	 * 
	 ...
	 * {@link ZooKeeper#updateServerList(String)}
	 *
	 * @return true/false
	 */
