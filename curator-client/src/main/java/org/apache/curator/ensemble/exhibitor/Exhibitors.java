...
public class Exhibitors {
	 ...
	 * @param restPort                       the REST port used to connect to
	 *                                       Exhibitor
	 * @param backupConnectionStringProvider in case an Exhibitor instance can't be
	 *                                       contacted, returns the fixed connection
	 *                                       string to use as a backup
	 */
