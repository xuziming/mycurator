...
/**
 * <p>
 * Drop in replacement for: org.apache.zookeeper.recipes.queue.DistributedQueue
 * that is part of the ZooKeeper distribution
 * </p>
 *
 * <p>
 * This class is data compatible with the ZK version. i.e. it uses the same
 * naming scheme so it can read from an existing queue
 * </p>
 */
public class SimpleDistributedQueue {
	...
	public boolean offer(byte[] data) throws Exception {
		...
		client.create().creatingParentContainersIfNeeded().withMode(CreateMode.PERSISTENT_SEQUENTIAL).forPath(thisPath,
				data);
		return true;
	}
