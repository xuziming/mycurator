...
/**
 * Uses an {@link DistributedAtomicNumber} and allocates values in chunks for
 * better performance
 */
public class CachedAtomicLong {
	...
	/**
	 * Returns the next value (incrementing by 1). If a new chunk of numbers is
	 * needed, it is requested from the number
	 *
