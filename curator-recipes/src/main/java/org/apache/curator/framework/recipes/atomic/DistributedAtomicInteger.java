...
/**
 * <p>
 * A counter that attempts atomic increments. It first tries uses optimistic
 ...
 *
 * <p>
 * The various increment methods return an {@link AtomicValue} object. You must
...
public class DistributedAtomicInteger implements DistributedAtomicNumber<Integer> {
	...
	/**
	 * Add 1 to the current value and return the new value information. Remember to
	 * always check {@link AtomicValue#succeeded()}.
	 *
	 * @return value info
