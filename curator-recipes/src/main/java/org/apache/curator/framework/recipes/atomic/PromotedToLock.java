...
/**
 * Abstraction of arguments for mutex promotion. Use {@link #builder()} to
 * create.
 */
public class PromotedToLock {
	...
	public static class Builder {
		...
		public PromotedToLock build() {
			...
			return new PromotedToLock(instance.path, instance.maxLockTime, instance.maxLockTimeUnit,
		...
		public Builder lockPath(String path) {
			instance = new PromotedToLock(PathUtils.validatePath(path), instance.maxLockTime, instance.maxLockTimeUnit,
					instance.retryPolicy);
			return this;
		}
