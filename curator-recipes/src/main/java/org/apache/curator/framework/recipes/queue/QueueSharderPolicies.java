...
public class QueueSharderPolicies {
	...
	public static class Builder {
		...
		/**
		 * Change the queue threshold. This is the number of items that causes a new
		 * queue to be added. The default is
		 * {@link QueueSharderPolicies#DEFAULT_QUEUE_THRESHOLD}
		 *
		...
		/**
		 * Change the threshold check. This is how often the queue sizes are checked.
		 * The default is {@link QueueSharderPolicies#DEFAULT_THRESHOLD_CHECK_MS}
		 *
		...
		/**
		 * Change the maximum number of queues to create. The default value is
		 * {@link QueueSharderPolicies#DEFAULT_MAX_QUEUES}
		 *
