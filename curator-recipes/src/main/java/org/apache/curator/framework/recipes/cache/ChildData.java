...
public class ChildData implements Comparable<ChildData> {
	...
	/**
	 * <p>
	 * Returns the node data for this child when the cache mode is set to cache
	 * data.
	 * </p>
	 *
	 * <p>
	 * <b>NOTE:</b> the byte array returned is the raw reference of this instance's
	 * field. If you change the values in the array any other callers to this method
	 * will see the change.
	 * </p>
	 *
