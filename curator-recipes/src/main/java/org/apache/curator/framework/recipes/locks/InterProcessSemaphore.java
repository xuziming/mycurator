 ...
 * </p>
 *
 * @deprecated Use {@link InterProcessSemaphoreV2} instead of this class. It
 *             uses a better algorithm.
 */
@Deprecated
public class InterProcessSemaphore {
	...
	private InterProcessSemaphore(CuratorFramework client, String path, int maxLeases, SharedCountReader count) {
		...
		internals = new LockInternals(client, new StandardLockInternalsDriver(), path, LOCK_NAME,
