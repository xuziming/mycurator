...
public class GroupMember implements Closeable {
	...
	/**
	 * Start the group membership. Register thisId as a member and begin caching all
	 * members
	 */
	@SuppressWarnings("deprecation")
	public void start() {
	...
	/**
	 * Return the current view of membership. The keys are the IDs of the members.
	 * The values are each member's payload
	 *
	 * @return membership
	 */
