	...
	public void testAclErrorWithLeader() throws Exception {
		...
		try {
			...
			try {
				...
				// use a path below "base" as noAuthClient is not authorized to create nodes in
				// "/base"
				// but also making sure that the code goes through the
				// backgroundCreateParentsThenNode() codepath
