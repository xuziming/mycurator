...
public class BaseTestTreeCache extends BaseClassForTests {
	...
	/**
	 * Finish constructing a TreeCache that records exceptions and automatically
	 * listens.
	 */
	...
	public void teardown() throws Exception {
		try {
			try {
				Assert.assertFalse(hadBackgroundException.get(),
						"Background exceptions were thrown, see stderr for details");
				assertNoMoreEvents();
			} finally {
	...
	TreeCacheEvent assertEvent(TreeCacheEvent.Type expectedType, String expectedPath, byte[] expectedData,
			boolean ignoreConnectionEvents) throws InterruptedException {
