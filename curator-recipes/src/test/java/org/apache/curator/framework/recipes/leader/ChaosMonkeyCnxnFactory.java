 ...
 * that it will unexpectedly close the connection right after the <b>first</b>
 * znode has been created in Zookeeper. Subsequent create operations will
 * succeed.
 */
public class ChaosMonkeyCnxnFactory extends NIOServerCnxnFactory {
	...
	public static class ChaosMonkeyZookeeperServer extends ZooKeeperServer {
		...
		public void submitRequest(Request si) {
			...
			if (si.type != ZooDefs.OpCode.createSession && si.type != ZooDefs.OpCode.sync
					&& si.type != ZooDefs.OpCode.ping && firstError != 0 && remaining > 0) {
