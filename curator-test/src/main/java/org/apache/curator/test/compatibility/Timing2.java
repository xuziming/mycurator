...
public class Timing2 {
	...
	private static final double SESSION_SLEEP_MULTIPLE = SESSION_MULTIPLE * 1.75; // has to be at least session + 2/3 of
																					// a session to account for missed
	 ...
	 * @return result of
	 *         {@link java.util.concurrent.Semaphore#tryAcquire(int, long, java.util.concurrent.TimeUnit)}
	 */
