...
public class TestingCluster implements Closeable {
	 ...
	 * Creates an ensemble using the given server specs
	 *
	 * @param specs map of an instance spec to its set of quorum instances. Allows
	 *              simulation of an ensemble with instances having different config
	 *              peers
	 */
	...
	/**
	 * Shutdown the ensemble, free resources, etc. If temp directories were used,
	 * they are deleted. You should call this in a <code>finally</code> block.
	 *
