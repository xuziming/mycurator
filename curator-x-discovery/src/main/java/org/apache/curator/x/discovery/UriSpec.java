...
/**
 * <p>
 * An abstraction for specifying a URI for an instance allowing for variable
 * substitutions.
 * </p>
 *
 * <p>
 * A Uri spec is a string with optional replacement fields. A replacement field
 * begins with an open brace and ends with a close brace. The value between the
 * braces is the name of the field. e.g. "{scheme}://foo.com:{port}" has two
 * replacement fields named "scheme" and "port". Several pre-defined fields are
 * listed as constants in this class (e.g. {@link #FIELD_SCHEME}).
 * </p>
 */
public class UriSpec implements Iterable<UriSpec.Part> {
	...
	/**
	 * This defaults to "http". If a {@link ServiceInstance} is passed when building
	 * and an sslPort is specified in the instance, the replacement is "https".
	 */
	public static final String FIELD_SCHEME = "scheme";

	/**
	 * If a {@link ServiceInstance} is passed when building, the replacement is
	 * {@link ServiceInstance#getName()}
	 */
	public static final String FIELD_NAME = "name";

	/**
	 * If a {@link ServiceInstance} is passed when building, the replacement is
	 * {@link ServiceInstance#getId()}
	 */
	public static final String FIELD_ID = "id";

	/**
	 * If a {@link ServiceInstance} is passed when building, the replacement is
	 * {@link ServiceInstance#getAddress()}
	 */
	public static final String FIELD_ADDRESS = "address";

	/**
	 * If a {@link ServiceInstance} is passed when building, the replacement is
	 * {@link ServiceInstance#getPort()}
	 */
	public static final String FIELD_PORT = "port";

	/**
	 * If a {@link ServiceInstance} is passed when building, the replacement is
	 * {@link ServiceInstance#getSslPort()}
	 */
	public static final String FIELD_SSL_PORT = "ssl-port";

	/**
	 * If a {@link ServiceInstance} is passed when building, the replacement is
	 * {@link ServiceInstance#getRegistrationTimeUTC()}
	 */
	public static final String FIELD_REGISTRATION_TIME_UTC = "registration-time-utc";

	/**
	 * If a {@link ServiceInstance} is passed when building, the replacement is
	 * {@link ServiceInstance#getServiceType()}
	 */
	 ...
	 * Build into a UriSpec string
	 *
	 * @param variables a mapping of field replacement names to values. Note: any
	 *                  fields listed in this map override pre-defined fields
	 * @return UriSpec string
	 */
	 ...
	 *
	 * @param serviceInstance instance to use for pre-defined replacement fields
	 * @param variables       a mapping of field replacement names to values. Note:
	 *                        any fields listed in this map override pre-defined
	 *                        fields
	 * @return UriSpec string
	 */
	public String build(ServiceInstance<?> serviceInstance, Map<String, Object> variables) {
		...
		if (serviceInstance != null) {
			...
			localVariables.put(FIELD_SERVICE_TYPE,
					(serviceInstance.getServiceType() != null) ? serviceInstance.getServiceType().name().toLowerCase()
							: "");
