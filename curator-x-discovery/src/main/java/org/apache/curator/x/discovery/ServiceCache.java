...
public interface ServiceCache<T> extends Closeable, Listenable<ServiceCacheListener>, InstanceProvider<T> {
	 ...
	 * freshness. This is merely the last known list of instances. However, the list
	 * is updated via a ZooKeeper watcher so it should be fresh within a window of a
	 * second or two.
	 *
	 * @return the list
	 */
