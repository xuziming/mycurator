...
public class ServiceDiscoveryBuilder<T> {
	 ...
	 *
	 * @param payloadClass the class of the payload of your service instance (you
	 *                     can use {@link Void} if your instances don't need a
	 *                     payload)
	 * @return new builder
	 */
	...
	/**
	 * Build a new service discovery with the currently set values. If not set, the
	 * builder will be defaulted with a {@link JsonInstanceSerializer}.
	 *
	...
	/**
	 * Optional - instance that represents the service that is running. The instance
	 ...
	 * {@link #thisInstance(ServiceInstance)} or
	 * {@link ServiceDiscovery#registerService(ServiceInstance)}). If the data for
	 * instances changes, they are reloaded.
	 *
