...
public interface ServiceProviderBuilder<T> {
	...
	/**
	 * optional - set the provider strategy. The default is
	 * {@link RoundRobinStrategy}
	 *
	...
	/**
	 * Add an instance filter. NOTE: this does not remove previously added filters.
	 * i.e. a l;ist is created of all added filters. Filters are called in the order
	 * they were added.
	 *
