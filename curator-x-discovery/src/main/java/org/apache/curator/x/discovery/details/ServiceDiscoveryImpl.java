...
public class ServiceDiscoveryImpl<T> implements ServiceDiscovery<T> {
	 ...
	 * @param serializer     serializer for instances (e.g.
	 *                       {@link JsonInstanceSerializer})
	 * @param thisInstance   instance that represents the service that is running.
	 *                       The instance will get auto-registered
	...
	/**
	 * Allocate a new builder. {@link ServiceProviderBuilder#providerStrategy} is
	 * set to {@link RoundRobinStrategy}
	 *
	 * @return the builder
	 */
	@Override
	...
	/**
	 * Allocate a new service cache builder. The refresh padding is defaulted to 1
	 * second.
	 *
