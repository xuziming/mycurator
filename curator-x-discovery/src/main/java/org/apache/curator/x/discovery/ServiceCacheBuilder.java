...
public interface ServiceCacheBuilder<T> {
	...
	/**
	 * Optional thread factory to use for the cache's internal thread. The specified
	 * ExecutorService overrides any prior ThreadFactory or ExecutorService set on
	 * the ServiceCacheBuilder.
	 *
	 ...
	 * specified ExecutorService will be wrapped in a CloseableExecutorService and
	 ...
	 * The specified ExecutorService overrides any prior ThreadFactory or
	 * ExecutorService set on the ServiceCacheBuilder.
	 *
