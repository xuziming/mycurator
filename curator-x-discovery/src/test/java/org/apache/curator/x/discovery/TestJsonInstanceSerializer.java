...
public class TestJsonInstanceSerializer {
	...
	public void testWrongPayloadType() throws Exception {
		...
		byte[] bytes = stringSerializer.serialize(new ServiceInstance<String>("name", "id", "address", 10, 20,
				"payload", 0, ServiceType.DYNAMIC, new UriSpec("{a}/b/{c}"), true));
		try {
	...
	public void testPayloadAsList() throws Exception {
		...
		ServiceInstance<Object> instance = new ServiceInstance<Object>("name", "id", "address", 10, 20, payload, 0,
	...
	public void testPayloadClass() throws Exception {
		...
		ServiceInstance<Payload> instance = new ServiceInstance<Payload>("name", "id", "address", 10, 20, payload, 0,
				ServiceType.DYNAMIC, new UriSpec("{a}/b/{c}"), true);
		byte[] bytes = serializer.serialize(instance);
