...
/**
 * <p>
 * Abstraction that allows the construction of ModeledFrameworks using strongly
 * typed parameter replacements. For example, given a ModeledFramework with a
 * ModelSpec that has a path such as "/root/registry/people/{id}" where "id"
 * should be <code>PersonId</code>.
 * </p>
 *
 * <p>
 * 
...
public interface TypedModeledFramework<M, P1> {
	 ...
	 * and typed model spec. When {@link #resolved(AsyncCuratorFramework, Object)}
	 ...
	 * {@link #resolved(AsyncCuratorFramework, Object)} is called the actual
