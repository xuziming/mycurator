...
/**
 * <p>
 * Abstraction that allows the construction of ModelSpecs using strongly typed
 * parameter replacements. For example, given a ModelSpec with a path such as
...
public interface TypedModelSpec<M, P1> {
	 ...
	 * path. When {@link #resolved(Object)} is called the actual model spec is
	 ...
	 * {@link #resolved(Object)} is called the actual model spec is generated with
	 * the resolved path
	 *
	 * @param builder     model spec builder
