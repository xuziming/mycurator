...
public interface ModeledCacheListener<T> {
	...
	/**
	 * Called when there is an exception processing a message from the internal
	 * cache. This is most likely due to a de-serialization problem.
	 *
	 ...
	 * once {@link #initialized()} has been called. i.e. changes that occur as the
	 * cache is initializing are not sent to the listener
	 *
