...
class AsyncDeleteBuilderImpl implements AsyncDeleteBuilder {
	...
	public AsyncStage<Void> forPath(String path) {
		...
		DeleteBuilderImpl builder = new DeleteBuilderImpl(client, version, common.backgrounding,
				options.contains(DeleteOption.deletingChildrenIfNeeded), options.contains(DeleteOption.guaranteed),
