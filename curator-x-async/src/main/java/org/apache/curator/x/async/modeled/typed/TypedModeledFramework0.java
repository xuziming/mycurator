...
public interface TypedModeledFramework0<M> {
	 ...
	 * {@link #resolved(org.apache.curator.x.async.AsyncCuratorFramework)} is called
	 ...
	 */
	static <M> TypedModeledFramework0<M> from(ModeledFrameworkBuilder<M> frameworkBuilder,
			TypedModelSpec0<M> modelSpec) {
