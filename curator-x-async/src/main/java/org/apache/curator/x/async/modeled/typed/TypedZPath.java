...
/**
 * <p>
 * Abstraction that allows the construction of ZPaths using strongly typed
 * parameter replacements. For example, given a path such as
 ...
 *
 * <p>
 * Additionally, if you have a model/class that implements
 * {@link org.apache.curator.x.async.modeled.NodeName} you can pass that when
 * resolving. E.g.
 * </p>
 *
 * <p>
...
public interface TypedZPath<T> {
	 ...
	 * {@link org.apache.curator.x.async.modeled.ZPath#parseWithIds}
	 *
	 * @param pathWithIds path to pass to
	 *                    {@link org.apache.curator.x.async.modeled.ZPath#parseWithIds}
	 * @return TypedZPath
	 */
