...
public interface AsyncCreateBuilder extends AsyncPathAndBytesable<AsyncStage<String>> {
	...
	/**
	 * Use the given create mode. The default is
	 * {@link org.apache.zookeeper.CreateMode#PERSISTENT}
	 *
	 ...
	 * {@link org.apache.zookeeper.ZooDefs.Ids#OPEN_ACL_UNSAFE})
	 *
	 ...
	 * {@link org.apache.zookeeper.CreateMode#PERSISTENT_WITH_TTL} or
	 * {@link org.apache.zookeeper.CreateMode#PERSISTENT_SEQUENTIAL_WITH_TTL}. If
	 * the znode has not been modified within the given TTL, it will be deleted once
	 * it has no children. The TTL unit is milliseconds and must be greater than 0
	 * and less than or equal to EphemeralType.MAX_TTL.
	 *
	 * @param ttl the ttl
	 ...
	 */
	AsyncPathAndBytesable<AsyncStage<String>> withOptions(Set<CreateOption> options, CreateMode createMode,
			List<ACL> aclList, Stat stat, long ttl);
	 ...
	 */
	AsyncPathAndBytesable<AsyncStage<String>> withOptions(Set<CreateOption> options, CreateMode createMode,
			List<ACL> aclList, Stat stat, long ttl, int setDataVersion);
}
