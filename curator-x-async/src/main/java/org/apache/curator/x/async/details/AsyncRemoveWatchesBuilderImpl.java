...
class AsyncRemoveWatchesBuilderImpl implements AsyncRemoveWatchesBuilder, AsyncPathable<AsyncStage<Void>> {
	...
	public AsyncStage<Void> forPath(String path) {
		...
		RemoveWatchesBuilderImpl builder = new RemoveWatchesBuilderImpl(client, watcher, curatorWatcher, watcherType,
				options.contains(RemoveWatcherOption.guaranteed), options.contains(RemoveWatcherOption.local),
				options.contains(RemoveWatcherOption.guaranteed), common.backgrounding);
