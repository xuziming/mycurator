...
public class ModeledFrameworkBuilder<T> {
	...
	public ModeledFramework<T> build() {
		return ModeledFrameworkImpl.build(client, modelSpec, watchMode, watcherFilter, unhandledErrorListener,
				resultFilter, modeledOptions);
	}
	...
	/**
	 * Add watchers as appropriate using the given watchMode to the Modeled
	 * Curator's ZNode
	 *
	...
	/**
	 * Add watchers as appropriate using the given watchMode and filter to the
	 * Modeled Curator's ZNode
	 *
	 * @param watchMode     watcher style
	...
	/**
	 * Use the given unhandledErrorListener for operations on the Modeled Curator's
	 * ZNode
	 *
