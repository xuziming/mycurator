...
public class TestNewerModel {
	...
	public TestNewerModel(String firstName, String lastName, String address, int age, BigInteger salary,
			long newField) {
	...
	public boolean equalsOld(TestModel model) {
		return firstName.equals(model.getFirstName()) && lastName.equals(model.getLastName())
				&& address.equals(model.getAddress()) && salary.equals(model.getSalary()) && age == model.getAge();
	}
